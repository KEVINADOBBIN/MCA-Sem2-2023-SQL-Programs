-- ============================================
-- DBMS LAB
-- PROGRAM 02 + PROGRAM 02-1 (COMBINED)
-- MCA Department, St. Francis College
-- SQLite (GitHub Codespace Compatible)
-- ============================================
...
-- ============================================
-- PROGRAM 02-1 QUERIES
-- ============================================

-- DROP COLUMN MINIT
ALTER TABLE Employee DROP COLUMN minit;

-- Employees in Washington earning > 5000
...
-- Departments with manager names
SELECT d.dnumber, d.dname,
       e.fname || ' ' || e.lname AS Manager
FROM Department d
JOIN Employee e ON d.mgssn = e.ssn;

-- Employees earning more than average salary
SELECT * FROM Employee
WHERE salary > (SELECT AVG(salary) FROM Employee);

-- 10% raise for Research department
UPDATE Employee
...
-- Salary stats for Accounts department
SELECT d.dname,
